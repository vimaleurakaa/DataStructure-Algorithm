...
```
git clone https://github.com/vimaleurakaa/DataStructure-Algorithm.git
```
...
Then run this command in terminal `node run start`,<br>
This will start the project automatically on `localhost:1234` .<br>
...
3. All the result are are printed in console, alternatively you dont need a localhost to run this script simply execute the same in node environment you will see the result in node, best to use GitBash terminal for executing node command for windows users.
